...
const centerDotClassname =
  "before:absolute before:left-1/2 before:top-1/2 before:transform before:-translate-x-1/2 before:-translate-y-1/2 before:content-['+'] before:mix-blend-difference before:pointer-events-none";
